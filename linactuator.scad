...
sarafi_xy=15;
sarafi_navoj_d=1.8; // rupa za navoj sarafa gore
...
krug_d=10;
krug_h=0; // 0 disable mali krug oko sipke

rez_h=4; // dužina odrezanog dijela
rez_d=0.1; // veličina samog reza

matica_d=10.7;  // širina 6-kutne rupe da matica lagano prođe. Matica je široka 10 mm
ulaz_matica_h=0.6*2; // dubina proširenog ulaza za maticu
ulaz_matica_d=matica_d+2*ulaz_matica_h; // veličina proširenog ulaza
//matica_h=22.4; // dubina rupe za 2 matice i feder (2 matica su dugačke 8.3 mm, neopterećen feder je 13 mm)
matica_h=8.3+13; // feder 13 mm
podizac_h=matica_h+7; // +7 povecava sloj plastike koji drži maticu
sipka_d=7; // rupa za navojnu šipku, dosta lufta
prijelaz_h=(matica_d-sipka_d)*0; // visina konusnog 6-kutnog prijelaza od matice prema rupi za šipku da ne padnu slojevi
